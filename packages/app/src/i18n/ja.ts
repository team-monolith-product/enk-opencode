export const dict = {
  ...
  "session.tab.preview": "プレビュー",
  "session.preview.notReady": "プレビューはまだ準備できていません",
  ...
  "session.files.addToContext": "ドキュメントにファイルを追加",
  "session.files.addFolderToContext": "ドキュメントにフォルダを追加",

...
export const dict = {
  ...
  "session.files.addToContext": "将文件添加到文档",
  "session.files.addFolderToContext": "将文件夹添加到文档",
  ...
  "settings.general.row.followup.description": "选择跟进提示是排队、立即引导，还是在智能体忙碌时仅允许停止",
  "settings.general.row.followup.option.queue": "排队",
  "settings.general.row.followup.option.steer": "引导",
  "settings.general.row.followup.option.none": "无",

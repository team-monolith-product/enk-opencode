...
export const dict = {
  ...
  "envKeys.saved": "등록됨",
  "envKeys.saved.justNow": "방금 등록",
  "envKeys.saved.minutesAgo": "{{count}}분 전 등록",
  "envKeys.saved.hoursAgo": "{{count}}시간 전 등록",
  "envKeys.saved.at": "{{month}}월 {{day}}일 {{time}} 등록",
  "envKeys.replace": "값 교체",
  "envKeys.status.registered": "등록됨",

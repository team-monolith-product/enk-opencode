...
export const dict = {
  ...
  "prompt.mode.draw": "그리기",
  "prompt.mode.doc": "문서",
  "prompt.mode.shell.exit": "종료하려면 esc",
  "prompt.mode.draw.exit": "종료하려면 esc",
  ...
  "prompt.action.drawUndo": "실행 취소",
  "prompt.action.drawRedo": "다시 실행",
  ...
  "prompt.toast.drawEmpty.description": "그림, 텍스트 또는 첨부를 추가한 뒤 전송하세요.",
  ...
  "prompt.toast.drawImageTooLarge.title": "이미지가 너무 큼",
  "prompt.toast.drawImageTooLarge.description": "더 작은 이미지를 사용하세요.",
  "prompt.toast.drawImageCount.title": "이미지 개수 초과",
  "prompt.toast.drawImageCount.description": "다른 이미지를 제거한 뒤 추가하세요.",
  "prompt.toast.drawImageTotal.title": "캔버스 이미지 용량 초과",
  "prompt.toast.drawImageTotal.description": "이미지를 줄이거나 삭제하세요.",
  "prompt.toast.drawImageType.title": "지원하지 않는 형식",
  "prompt.toast.drawImageType.description": "캔버스에는 이미지 파일만 추가할 수 있습니다.",

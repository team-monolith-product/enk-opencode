...
export const dict = {
  ...
  "envKeys.description": "이름은 앱이 자동으로 정하고, 여기선 값만 붙여넣으면 돼요. 값은 저장 후 다시 보이지 않고, AI에게 전달되지 않아요.",
  "envKeys.empty.title": "아직 연결이 없어요",
  "envKeys.empty": "앱이 사용하는 외부 정보가 있으면 여기에 이름이 표시돼요.",
  ...
  "envKeys.error.load.hint": "잠시 후 다시 시도해 주세요. 저장해 둔 값은 그대로 있어요.",

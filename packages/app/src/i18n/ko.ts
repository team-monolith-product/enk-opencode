...
export const dict = {
  ...
  "envKeys.empty": "아직 등록된 환경변수가 없어요.",
  "envKeys.field.key.label": "이름",
  "envKeys.field.key.placeholder": "API_KEY",
  "envKeys.field.value.label": "값",
  "envKeys.field.value.placeholder": "값 입력",
  "envKeys.add": "변수 추가",
  "envKeys.remove": "행 삭제",
  "envKeys.delete": "삭제",
  "envKeys.delete.confirm": "삭제 확인",
  "envKeys.toast.saved.title": "환경변수 저장됨",
  "envKeys.toast.saved.description": "프로젝트 .env 파일에 저장되었습니다",
  "envKeys.error.load": "저장된 목록을 불러오지 못했습니다. 서버가 아직 이 기능을 지원하지 않을 수 있습니다.",

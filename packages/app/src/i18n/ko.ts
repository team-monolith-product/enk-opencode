...
export const dict = {
  ...
  "command.env.keys": "외부 연동",
  "command.env.keys.description": "앱이 쓸 외부 서비스 값 관리",
  "command.env.keys.badge": "저장된 연결 {{count}}개",
  "envRequest.title": "안전 입력",
  "envRequest.field.name.label": "이름",
  ...
  "envRequest.cancel": "취소",
  "envRequest.save": "안전하게 저장",
  "envKeys.title": "외부 연동 관리",
  "envKeys.description": "API 키를 입력, 추가, 삭제할 수 있어요. 저장하면 변경 내용 반영을 위해 미리보기를 재시작해요.",
  "envKeys.empty.title": "아직 연결이 없어요",
  "envKeys.empty": "앱이 외부 서비스를 쓰기 시작하면 필요한 이름이 여기에 자동으로 나타나요.",
  "envKeys.field.key.label": "이름",
  "envKeys.field.key.placeholder": "이름 (예: OPENWEATHER_KEY)",
  "envKeys.field.value.label": "값",
  "envKeys.field.value.placeholder": "값 붙여넣기",
  "envKeys.field.value.replacePlaceholder": "새 값 입력",
  "envKeys.status.replace": "저장하면 적용",
  "envKeys.status.drop": "삭제 예정",
  "envKeys.aria.value": "{{name}} 등록된 값, 클릭해서 수정",
  "envKeys.aria.replace": "{{name}} 저장하면 적용, 클릭해서 수정",
  "envKeys.aria.reveal": "{{name}} 값 보기",
  "envKeys.aria.hide": "{{name}} 값 숨기기",
  "envKeys.aria.delete": "{{name}} 삭제",
  "envKeys.aria.deleteUndo": "{{name}} 삭제 취소",
  "envKeys.summary.prefix": "저장하면",
  "envKeys.summary.suffix": "반영돼요",
  "envKeys.summary.replace": "교체 {{count}}건",
  "envKeys.summary.drop": "삭제 {{count}}건",
  "envKeys.add": "직접 추가",
  "envKeys.delete": "삭제",
  "envKeys.delete.undo": "삭제 취소",
  ...
  "command.github.description": "이 프로젝트를 GitHub 저장소에 올리기",
  "github.title": "GitHub에 올리기",
  "github.description.unlinked": "GitHub 계정을 연결하면 이 프로젝트를 저장소에 올릴 수 있어요.",
  "github.description.choose": "올릴 저장소를 새로 만들거나 이미 있는 저장소를 골라 주세요.",
  ...
  "github.waiting": "새로 열린 짓다 창에서 연결을 마치고 돌아오면 자동으로 반영돼요.",
  "github.account.by": "{{name}}님이 연결",
  "github.repo.new": "새로 만들기",
  "github.repo.existing": "기존 저장소",
  "github.repo.name.label": "저장소 이름",
  "github.repo.name.hint": "영문, 숫자, - _ . 만 쓸 수 있어요",
  "github.repo.public.hint": "인터넷의 누구나 볼 수 있어요",
  "github.repo.create": "저장소 만들기",
  "github.repo.use": "이 저장소 쓰기",
  "github.repo.empty": "아직 저장소가 없어요",
  "github.repo.change": "바꾸기",
  "github.repo.private.badge": "비공개",
  "github.repo.public.badge": "공개",
  "github.push.last": "{{time}}에 올림",
  "github.push.lastBy": "{{time}}에 {{name}}님이 올림",
  "github.push.never": "아직 올린 적이 없어요",
  "github.push.message.label": "무엇을 바꿨나요?",
  "github.push.message.placeholder": "예: 로그인 화면 추가 (안 써도 돼요)",
  "github.push.submit": "GitHub에 올리기",
  "github.push.pending": "올리는 중…",
  "github.push.done": "GitHub에 올렸어요",
  "github.push.open": "GitHub에서 보기",
  "github.push.unchanged": "지난번 이후 바뀐 게 없어서 올리지 않았어요",
  "github.push.skipped": "올리지 못한 파일: {{files}}",
  "github.push.defaultMessage": "짓다에서 올림",
  "github.error.load": "GitHub 상태를 불러오지 못했어요",
  "github.error.unlinked": "GitHub 연결이 해제됐어요",
  "github.error.norepo": "먼저 저장소를 골라 주세요",
  "github.error.exists": "같은 이름의 저장소가 이미 있어요. 다른 이름을 써 주세요",
  "github.error.forbidden": "이 저장소에 올릴 권한이 없어요",
  "github.error.revoked": "GitHub 권한이 사라졌어요. 짓다에서 다시 연결해 주세요",
  "github.error.missing": "저장소를 찾을 수 없어요",
  "github.error.empty": "올릴 파일이 없어요",
  "github.error.remote": "GitHub에 연결하지 못했어요. 잠시 후 다시 시도해 주세요",
  "github.error.disabled": "이 작업 공간에서는 GitHub를 쓸 수 없어요",
  "github.readonly": "관전 중에는 GitHub 설정을 바꿀 수 없어요.",
  ...
  "prompt.placeholder.summarizeComments": "컨텍스트에 추가한 내용 요약…",
  "prompt.placeholder.summarizeComment": "컨텍스트에 추가한 내용 요약…",
  "prompt.mode.shell": "셸",
  "prompt.mode.normal": "프롬프트",
  "prompt.mode.doc": "문서",
  "prompt.mode.shell.exit": "종료하려면 esc",
  "prompt.mode.doc.exit": "종료하려면 esc",
  ...
  "prompt.capture.close": "닫기",
  "prompt.capture.toolPen": "펜",
  "prompt.capture.toolEraser": "지우개",
  "prompt.capture.toolUndo": "실행 취소",
  "prompt.capture.toolCrop": "자르기",
  "prompt.capture.toolCropDone": "자르기 완료",
  "prompt.capture.zoomIn": "확대",
  ...
  "prompt.toast.docAdvanceFailed.description": "프롬프트는 전송되었지만 다음 협업 문서로 바꾸지 못했습니다.",
  ...
  "prompt.toast.captureFailed.title": "캡처 실패",
  "prompt.toast.captureFailed.description": "미리보기를 캡처하지 못했습니다. 로드됐는지 확인하고 다시 시도하세요.",
  ...
  "session.preview.retry.button": "다시 시도",
  "session.preview.retry.noServer": "아직 미리보기 서버가 시작되지 않았어요",
  "session.preview.retry.failed": "미리보기 서버를 다시 시작하지 못했어요",
  "session.preview.startable.title": "미리보기가 실행되지 않았어요",
  "session.preview.startable.hint": "아래 버튼으로 다시 시도해 보세요",
  "session.preview.none.title": "아직 미리보기 서버가 없어요",
  ...
  "session.files.addToContext": "문서에 파일 추가",
  "session.files.addFolderToContext": "문서에 폴더 추가",
  "session.files.empty": "파일 없음",
  "session.files.delete.label": "삭제",
  "session.files.delete.done": "{{name}} 삭제했어요",
  "session.files.delete.confirm.title": "{{name}} 삭제할까요?",
  "session.files.delete.confirm.title.all": "모두 삭제할까요?",
  "session.files.delete.confirm.body": "파일 {{count}}개 ({{size}})가 삭제돼요.",
  "session.files.delete.confirm.action": "삭제",
  "session.files.upload.label": "업로드",
  "session.files.upload.files": "파일 업로드",
  "session.files.upload.folder": "폴더 업로드",
  "session.files.upload.progress": "업로드 중 {{done}} / {{total}}",
  ...
  "workspace.reset.archived.none": "초기화할 대화가 없어요.",
  "workspace.reset.archived.one": "대화 1개를 초기화해요.",
  "workspace.reset.archived.many": "대화 {{count}}개를 초기화해요.",
  "workspace.reset.note": "이 작업은 작업 공간을 기본 브랜치와 일치하도록 재설정합니다.",
  "session.clear.title": "대화 초기화",
  "session.clear.description": "지금 보고 있는 대화를 정리하고 새 대화로 넘어가요.",
  "session.clear.confirm": "이 대화를 초기화할까요?",
  "session.clear.note": "초기화한 뒤에는 이 대화를 다시 열 수 없어요. 작업한 파일은 그대로 남아요.",
  "session.clear.button": "대화 초기화",
  "session.clear.failed.title": "대화 초기화 실패",
  "common.open": "열기",
  ...
  // 합의(동의) 다이얼로그 — 전송·질문·중지·대화 초기화 투표가 같은 문구 틀을 쓴다.
  "docSubmit.headline.doc": "이 프롬프트, 보낼까요?",
  "docSubmit.headline.questionSend": "이 답변, 보낼까요?",
  "docSubmit.headline.questionDismiss": "이 질문, 닫을까요?",
  "docSubmit.headline.questionBack": "이전 질문으로 돌아갈까요?",
  "docSubmit.headline.stop": "AI 응답을 멈출까요?",
  "docSubmit.headline.clear": "이 대화를 초기화할까요?",
  "docSubmit.requestVerb.doc": "전송을",
  "docSubmit.requestVerb.questionDismiss": "닫기를",
  "docSubmit.requestVerb.questionBack": "되돌리기를",
  "docSubmit.requestVerb.stop": "중지를",
  "docSubmit.requestVerb.clear": "초기화를",
  "docSubmit.approve.doc": "수락하고 보내기",
  "docSubmit.approve.questionDismiss": "수락하고 닫기",
  "docSubmit.approve.questionBack": "수락하고 돌아가기",
  "docSubmit.approve.stop": "수락하고 멈추기",
  "docSubmit.approve.clear": "초기화 수락하기",
  "docSubmit.exclude.doc": "나간 인원 제외하고 보내기",
  "docSubmit.exclude.questionDismiss": "나간 인원 제외하고 닫기",
  "docSubmit.exclude.questionBack": "나간 인원 제외하고 돌아가기",
  "docSubmit.exclude.stop": "나간 인원 제외하고 멈추기",
  "docSubmit.exclude.clear": "나간 인원 제외하고 초기화",
  "docSubmit.proceed.doc": "전송돼요",
  "docSubmit.proceed.questionDismiss": "닫혀요",
  "docSubmit.proceed.questionBack": "되돌아가요",
  "docSubmit.proceed.stop": "멈춰요",
  "docSubmit.proceed.clear": "초기화돼요",
  "docSubmit.warn.doc": "전송 후에는 AI 응답을 취소할 수 없어요. 거절하면 다시 편집할 수 있어요.",
  "docSubmit.warn.questionDismiss": "닫으면 이 질문은 사라져요. 거절하면 그대로 둘 수 있어요.",
  "docSubmit.warn.questionBack": "되돌리면 이 질문의 답변이 초기화돼요. 거절하면 그대로 둘 수 있어요.",
  "docSubmit.warn.stop": "멈추면 진행 중인 AI 응답이 중단돼요. 거절하면 계속 진행돼요.",
  "docSubmit.warn.clear": "초기화하면 이 대화는 다시 열 수 없어요. 작업한 파일은 그대로 남아요.",
  "docSubmit.hint.doc": "모두 동의하면 바로 AI에게 전송돼요",
  "docSubmit.hint.questionDismiss": "모두 동의하면 질문을 닫아요",
  "docSubmit.hint.questionBack": "모두 동의하면 이전 질문으로 돌아가요",
  "docSubmit.hint.stop": "모두 동의하면 AI 응답을 멈춰요",
  "docSubmit.hint.clear": "모두 동의하면 이 대화를 초기화해요",
  "docSubmit.requester.fallback": "참여자",
  "docSubmit.request.line": "{em}님이 {{verb}} 요청했어요",
  "docSubmit.snapshot.failed": "문서를 불러올 수 없습니다.",
  "docSubmit.preview.noAnswer": "미선택",
  "docSubmit.count.people": "{{count}}명",
  "docSubmit.status.allAgreed": "모두 동의했어요",
  "docSubmit.status.soon": "곧 {{verb}}",
  "docSubmit.status.departed": "{em}이 나갔어요 · 요청자가 진행을 정해요",
  "docSubmit.status.remaining": "{em}이 더 동의하면 {{verb}}",
  "docSubmit.status.onlyMe": "이제 {em} 동의하면 {{verb}}",
  "docSubmit.status.onlyMe.em": "나만",
  "docSubmit.action.reject": "거절",
  "docSubmit.action.cancel": "동의 취소",
  "docSubmit.actor.me": " (나)",
  "docSubmit.actor.requester": " · 요청자",
  "docSubmit.actor.waiting": "대기 중",
  "docSubmit.actor.left": "나감",
  "docSubmit.actor.agreed": "동의함",
  "docSubmit.waiting.leftOnly": "나간 팀원만 응답하지 않았어요",
  "docSubmit.waiting.allAgreed": "모두 동의했어요. 진행할게요",
  "docSubmit.waiting.pending": "동의했어요. 팀원을 기다려요",
  "docSubmit.waiting.excludable": "제외하고 보내거나, 돌아올 때까지 기다릴 수 있어요",
  "docSubmit.countdown.autoReject": "자동 거절까지 {{sec}}초",
  "docSubmit.failed.left.title": "전송이 무산됐어요",
  "docSubmit.failed.left.sub": "팀원이 캔버스를 나가 합의가 깨졌어요. 다시 모이면 보낼 수 있어요.",
  "docSubmit.failed.expired.title": "시간이 초과되었어요",
  "docSubmit.failed.expired.sub": "{{sec}}초 안에 모두 동의하지 않아 전송되지 않았어요. 다시 시도해 주세요.",
  "docSubmit.failed.cancelled.title": "전송이 취소되었어요",
  "docSubmit.failed.cancelled.sub": "캔버스로 돌아가 내용을 다시 다듬은 뒤 보낼 수 있어요.",
  "docSubmit.failed.back.count": "{{sec}}초 후 캔버스로 돌아가요",
  "docSubmit.failed.back.now": "지금 돌아가기",
  "docSubmit.aria.failed": "합의 무산",
  "docSubmit.aria.dialog": "전송 동의",
  "docSubmit.toast.approveFailed": "전송 동의 실패",
  "docSubmit.toast.cancelFailed": "전송 동의 취소 실패",
  "docSubmit.toast.sendFailed": "전송 실패",
  "docSubmit.toast.requestFailed": "전송 동의 요청 실패",
  "docSubmit.toast.stopRequestFailed": "중지 동의 요청 실패",
  "docSubmit.toast.clearRequestFailed": "대화 초기화 동의 요청 실패",
}

...
export const dict = {
  ...
  "command.env.keys": "API 키 관리",
  "command.env.keys.description": "프로젝트 .env 파일에 API 키 저장",
  "envKeys.title": "API 키",
  "envKeys.description":
    "키는 프로젝트 .env 파일에 저장됩니다. 값은 쓰기 전용이라 다시 표시되지 않으며 AI에게도 보이지 않습니다.",
  "envKeys.existing.label": "저장된 키",
  "envKeys.existing.placeholder": "•••••••• (변경 없음)",
  "envKeys.new.label": "새 키",
  "envKeys.field.key.label": "키",
  "envKeys.field.key.placeholder": "API_KEY",
  "envKeys.field.value.label": "값",
  "envKeys.field.value.placeholder": "값",
  "envKeys.add": "키 추가",
  "envKeys.remove": "행 삭제",
  "envKeys.delete": "키 삭제",

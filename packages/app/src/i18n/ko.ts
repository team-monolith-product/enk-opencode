...
export const dict = {
  ...
  "session.clear.title": "세션 지우기",
  "session.clear.description": "지금 보고 있는 대화를 정리하고 새 세션으로 넘어가요.",
  "session.clear.confirm": "이 세션을 지울까요?",
  "session.clear.note": "지운 뒤에는 이 대화를 다시 열 수 없어요.",
  "session.clear.button": "세션 지우기",
  "common.open": "열기",

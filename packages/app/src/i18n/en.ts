export const dict = {
  ...
  "command.env.keys": "Manage API keys",
  "command.env.keys.description": "Save API keys to the project .env file",
  "envKeys.title": "API keys",
  "envKeys.description":
    "Keys are saved to the project's .env file. Values are write-only: they are never shown again and are hidden from the AI.",
  "envKeys.existing.label": "Saved keys",
  "envKeys.existing.placeholder": "•••••••• (unchanged)",
  "envKeys.new.label": "New keys",
  "envKeys.field.key.label": "Key",

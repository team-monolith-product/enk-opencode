export const dict = {
  ...
  "command.category.env": "Environment",
  ...
  "command.env.keys": "Integrations",
  "command.env.keys.description": "Manage values for external services the app uses",
  "command.env.keys.badge": "{{count}} saved connections",
  "envRequest.title": "Secure input",
  "envRequest.field.name.label": "Name",
  ...
  "envKeys.field.key.placeholder": "Name (e.g. OPENWEATHER_KEY)",
  "envKeys.field.value.label": "Value",
  "envKeys.field.value.placeholder": "Paste value",
  "envKeys.field.value.replacePlaceholder": "Enter new value",
  "envKeys.status.replace": "Applied on save",
  "envKeys.status.drop": "Will be removed",
  "envKeys.aria.value": "{{name}} saved value, click to edit",
  "envKeys.aria.replace": "{{name}} applied on save, click to edit",
  "envKeys.aria.reveal": "Show {{name}} value",
  "envKeys.aria.hide": "Hide {{name}} value",
  "envKeys.aria.delete": "Delete {{name}}",
  "envKeys.aria.deleteUndo": "Undo deleting {{name}}",
  "envKeys.summary.prefix": "Saving applies",
  "envKeys.summary.suffix": "",
  "envKeys.summary.replace": "{{count}} replaced",
  "envKeys.summary.drop": "{{count}} removed",
  "envKeys.add": "Add manually",
  "envKeys.delete": "Delete",
  "envKeys.delete.undo": "Undo delete",
  "envKeys.toast.saved.title": "Connection values saved",
  "envKeys.toast.saved.description": "Preview restarted",
  "envKeys.error.load": "Could not load connections",
  "envKeys.error.load.hint":
    "Try again in a moment. Everything you saved is still there. If it keeps failing, let an organizer know.",
  "envKeys.error.retry": "Retry",
  "envKeys.error.invalidKey": "Use letters, digits and underscores; must not start with a digit",
  "envKeys.error.duplicate": "This name already exists",
  "envKeys.error.valueRequired": "Enter a value",
  "command.github": "GitHub",
  "command.github.description": "Push this project to a GitHub repository",
  "github.title": "Push to GitHub",
  "github.description.unlinked": "Link a GitHub account to push this project to a repository.",
  "github.description.choose": "Create a repository to push to, or pick one you already have.",
  ...
  "github.waiting": "Finish linking in the Jitda tab, then come back — this updates on its own.",
  "github.account.by": "Linked by {{name}}",
  "github.repo.new": "New repository",
  "github.repo.existing": "Use existing",
  "github.repo.name.label": "Repository name",
  "github.repo.name.hint": "Use English letters, numbers, - _ . only",
  "github.repo.public.hint": "Anyone on the internet can see it",
  "github.repo.create": "Create repository",
  "github.repo.use": "Use this repository",
  "github.repo.empty": "No repositories yet",
  "github.repo.change": "Change",
  "github.repo.private.badge": "Private",
  "github.repo.public.badge": "Public",
  "github.push.last": "Last pushed {{time}}",
  "github.push.lastBy": "Last pushed {{time}} by {{name}}",
  "github.push.never": "Not pushed yet",
  "github.push.message.label": "What changed?",
  "github.push.message.placeholder": "e.g. Added the login screen (optional)",
  "github.push.submit": "Push to GitHub",
  "github.push.pending": "Pushing…",
  "github.push.done": "Pushed to GitHub",
  "github.push.open": "Open on GitHub",
  "github.push.unchanged": "Nothing changed since the last push",
  "github.push.skipped": "Left out: {{files}}",
  "github.push.defaultMessage": "Update from Jitda",
  "github.error.load": "Couldn't load GitHub status",
  "github.error.unlinked": "GitHub isn't linked anymore",
  "github.error.norepo": "Choose a repository first",
  "github.error.exists": "A repository with this name already exists",
  "github.error.forbidden": "You can't push to this repository",
  "github.error.revoked": "GitHub access was revoked. Link again in Jitda",
  "github.error.missing": "Couldn't find the repository",
  "github.error.empty": "There are no files to push",
  "github.error.remote": "Couldn't reach GitHub. Try again in a moment",
  "github.error.disabled": "GitHub isn't available in this workspace",
  "github.readonly": "Spectators can't change GitHub settings.",
  ...
  "session.preview.retry.button": "Try again",
  "session.preview.retry.noServer": "The preview server hasn't started yet",
  "session.preview.retry.failed": "Couldn't restart the preview server",
  "session.preview.startable.title": "Preview isn't running",
  "session.preview.startable.hint": "Tap below to try starting it again",
  "session.preview.none.title": "No preview server yet",
  ...
  "session.files.delete.label": "Delete",
  "session.files.delete.done": "Deleted {{name}}",
  "session.files.delete.confirm.title": "Delete {{name}}?",
  "session.files.delete.confirm.title.all": "Delete everything?",
  "session.files.delete.confirm.body": "{{count}} files ({{size}}) will be deleted.",
  "session.files.delete.confirm.action": "Delete",
  "session.files.upload.label": "Upload",
  "session.files.upload.files": "Upload files",
  "session.files.upload.folder": "Upload a folder",
  "session.files.upload.progress": "Uploading {{done}} / {{total}}",
  ...
  "docSubmit.headline.doc": "Send this prompt?",
  "docSubmit.headline.questionSend": "Send this answer?",
  "docSubmit.headline.questionDismiss": "Dismiss this question?",
  "docSubmit.headline.questionBack": "Go back to the previous question?",
  "docSubmit.headline.stop": "Stop the AI response?",
  "docSubmit.headline.clear": "Reset this conversation?",
  "docSubmit.requestVerb.doc": "to send",
  "docSubmit.requestVerb.questionDismiss": "to dismiss",
  "docSubmit.requestVerb.questionBack": "to go back",
  "docSubmit.requestVerb.stop": "to stop",
  "docSubmit.requestVerb.clear": "to reset",
  "docSubmit.approve.doc": "Agree and send",
  "docSubmit.approve.questionDismiss": "Agree and dismiss",
  "docSubmit.approve.questionBack": "Agree and go back",
  "docSubmit.approve.stop": "Agree and stop",
  "docSubmit.approve.clear": "Accept the reset",
  "docSubmit.exclude.doc": "Send without those who left",
  "docSubmit.exclude.questionDismiss": "Dismiss without those who left",
  "docSubmit.exclude.questionBack": "Go back without those who left",
  "docSubmit.exclude.stop": "Stop without those who left",
  "docSubmit.exclude.clear": "Reset without those who left",
  "docSubmit.proceed.doc": "it sends",
  "docSubmit.proceed.questionDismiss": "it closes",
  "docSubmit.proceed.questionBack": "it goes back",
  "docSubmit.proceed.stop": "it stops",
  "docSubmit.proceed.clear": "it resets",
  "docSubmit.warn.doc": "Once sent, the AI response cannot be undone. Reject to keep editing.",
  ...
  "docSubmit.warn.clear": "Once reset, this conversation cannot be reopened. The files you worked on stay.",
  ...
  "docSubmit.hint.stop": "Once everyone agrees the AI response stops",
  "docSubmit.hint.clear": "Once everyone agrees this conversation is reset",
  "docSubmit.requester.fallback": "Participant",
  "docSubmit.request.line": "{em} asked {{verb}}",
  "docSubmit.snapshot.failed": "Could not load the document.",
  "docSubmit.preview.noAnswer": "Not selected",
  "docSubmit.count.people": "{{count}}",
  "docSubmit.status.allAgreed": "Everyone agreed",
  "docSubmit.status.soon": "{{verb}} shortly",
  "docSubmit.status.departed": "{em} left · the requester decides how to proceed",
  "docSubmit.status.remaining": "{em} more to agree and {{verb}}",
  "docSubmit.status.onlyMe": "Now {em} agree and {{verb}}",
  "docSubmit.status.onlyMe.em": "only I",
  "docSubmit.action.reject": "Reject",
  "docSubmit.action.cancel": "Withdraw",
  "docSubmit.actor.me": " (me)",
  "docSubmit.actor.requester": " · requester",
  "docSubmit.actor.waiting": "Waiting",
  "docSubmit.actor.left": "Left",
  "docSubmit.actor.agreed": "Agreed",
  "docSubmit.waiting.leftOnly": "Only those who left have not answered",
  "docSubmit.waiting.allAgreed": "Everyone agreed. Proceeding",
  "docSubmit.waiting.pending": "You agreed. Waiting for the others",
  "docSubmit.waiting.excludable": "Send without them, or wait until they are back",
  "docSubmit.countdown.autoReject": "{{sec}}s until auto-reject",
  "docSubmit.failed.left.title": "The send fell through",
  "docSubmit.failed.left.sub": "Someone left the canvas and consent broke. You can send once everyone is back.",
  "docSubmit.failed.expired.title": "Time ran out",
  "docSubmit.failed.expired.sub": "Not everyone agreed within {{sec}}s, so nothing was sent. Please try again.",
  "docSubmit.failed.cancelled.title": "The send was cancelled",
  "docSubmit.failed.cancelled.sub": "Head back to the canvas, polish it, and send again.",
  "docSubmit.failed.back.count": "Back to the canvas in {{sec}}s",
  "docSubmit.failed.back.now": "Go back now",
  "docSubmit.aria.failed": "Consent fell through",
  "docSubmit.aria.dialog": "Send consent",
  "docSubmit.toast.approveFailed": "Could not agree",
  "docSubmit.toast.cancelFailed": "Could not withdraw",
  "docSubmit.toast.sendFailed": "Send failed",
  "docSubmit.toast.requestFailed": "Could not ask for consent",
  "docSubmit.toast.stopRequestFailed": "Could not ask for consent to stop",
  "docSubmit.toast.clearRequestFailed": "Could not ask for consent to reset",
}

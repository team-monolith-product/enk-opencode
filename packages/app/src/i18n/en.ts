export const dict = {
  ...
  "command.env.keys": "Manage environment variables",
  ...
  "envRequest.notice.team": "Everyone on your team can see it.",
  ...
  "envKeys.empty": "No variables yet.",
  "envKeys.field.key.label": "Name",
  "envKeys.field.key.placeholder": "API_KEY",
  "envKeys.field.value.label": "Value",
  "envKeys.field.value.placeholder": "value",
  "envKeys.add": "Add variable",
  "envKeys.remove": "Remove row",
  "envKeys.delete": "Delete",
  "envKeys.delete.confirm": "Confirm delete",
  "envKeys.toast.saved.title": "Environment variables saved",
  "envKeys.toast.saved.description": "Saved to the project .env file",
  "envKeys.error.load": "Could not load the saved list. The server may not support this feature yet.",

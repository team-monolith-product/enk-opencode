export const dict = {
  ...
  "envKeys.saved": "Saved",
  "envKeys.saved.justNow": "Just registered",
  "envKeys.saved.minutesAgo": "Registered {{count}}m ago",
  "envKeys.saved.hoursAgo": "Registered {{count}}h ago",
  "envKeys.saved.at": "Registered {{month}}/{{day}} {{time}}",
  "envKeys.replace": "Replace value",
  "envKeys.status.registered": "Saved",

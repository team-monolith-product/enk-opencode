export const dict = {
  ...
  "envKeys.description": "Names are set by the app — just paste values here. Values are hidden after saving and are not passed to the AI.",
  "envKeys.empty.title": "No connections yet",
  "envKeys.empty": "If the app uses external credentials, their names show up here.",
  ...
  "envKeys.error.load.hint": "Try again in a moment. Saved values are still there.",

...
export const dict = {
  ...
  "session.tab.preview": "Vorschau",
  "session.preview.notReady": "Vorschau ist noch nicht bereit",
  ...
  "session.files.addToContext": "Datei zum Dokument hinzufügen",
  "session.files.addFolderToContext": "Ordner zum Dokument hinzufügen",

export const dict = {
  ...
  "session.tab.preview": "Pré-visualização",
  "session.preview.notReady": "A pré-visualização ainda não está pronta",
  ...
  "session.files.addToContext": "Adicionar arquivo ao documento",
  "session.files.addFolderToContext": "Adicionar pasta ao documento",
  ...
  "settings.general.row.followup.description":
    "Escolha se os prompts vão para fila, orientam na hora ou só permitem parar com o agente ocupado",
  "settings.general.row.followup.option.queue": "Fila",
  "settings.general.row.followup.option.steer": "Orientar",
  "settings.general.row.followup.option.none": "Nenhum",

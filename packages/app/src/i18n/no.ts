...
export const dict = {
  ...
  "session.preview.notReady": "Forhåndsvisningen er ikke klar ennå",
  ...
  "session.files.addFolderToContext": "Legg til mappe i dokument",
  ...
  "settings.general.row.followup.description":
    "Velg om oppfølging skal køes, styres umiddelbart eller bare tillate stopp mens agenten er opptatt",

...
// 본행사·튜토리얼 미리보기 호스트. 하나라도 빠지면 그 세션의 미리보기 iframe 이
// frame-src 위반으로 통째로 차단된다.
const PREVIEW_HOST = ServeTargets.previewHost("project") ?? ""
const TUTORIAL_PREVIEW_HOST = ServeTargets.previewHost("tutorial") ?? ""
...
const FRAME_SRC = origins("'self'", PREVIEW_HOST, TUTORIAL_PREVIEW_HOST, USER_RAILS_HOST)

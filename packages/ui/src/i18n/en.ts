export const dict: Record<string, string> = {
  ...
  "ui.pdfViewer.skip": "Skip to PDF content",
  "ui.pdfViewer.zoom": "Change zoom",
  "ui.pdfViewer.zoomLevel": "{{percent}}%",
  "ui.pdfViewer.fitWidth": "Fit to width",
  "ui.pdfViewer.fitHeight": "Fit to page",
  "ui.pdfViewer.slideshow": "Full screen",
  "ui.pdfViewer.thumbnails.open": "Show thumbnails",
  "ui.pdfViewer.thumbnails.close": "Hide thumbnails",
  "ui.pdfViewer.previous": "Previous",
  "ui.pdfViewer.next": "Next",
  "ui.pdfViewer.pageInput": "Page number",
  "ui.pdfViewer.pageLabel": "Page {{page}}",
  "ui.pdfViewer.pageError": "Couldn't load this page.",
  "ui.pdfViewer.loading": "Loading...",
  "ui.pdfViewer.error.title": "Couldn't load the file.",
  "ui.pdfViewer.error.description": "Refresh the page and try again.",
